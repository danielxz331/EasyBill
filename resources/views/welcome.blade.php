...
@section('content')
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <div class="contact_bt_main">
                            <div class="contact_bt"><a href="contact.html">Contactanos</a></div>
                        </div>
                    </div>
    ...
    <div class="about_section layout_padding">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h1 class="about_text">Sobre nosotros</h1>
                    <p class="lorem_text">There are many variations of passages of Lorem Ipsum available, but the majority
                        ...
                        have able</p>
                    <div class="read_bt1"><a href="#">Leer más</a></div>
                </div>
                <div class="col-md-6">
                    <div class="image_1"><img src="{{ asset('img/restaurant-.png') }}"></div>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="container_main">
                            <img src="{{ asset('img/imagenRestaurante.jpg') }}" alt="Avatar" class="image">
                            <div class="overlay">
                    ...
                    <div class="col-md-6">
                        <div class="container_main">
                            <img src="{{ asset('img/Mesa.jpg') }}" alt="Avatar" class="image">
                            <div class="overlay">
                                <a href="#" class="icon" title="User Profile">
                                    <i class="fa fa-search"></i>
                                </a>
